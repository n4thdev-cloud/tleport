...
public class ServletWebServerFactoryAutoConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<ServletWebServerFactoryCustomizer> getServletWebServerFactoryCustomizerInstanceSupplier(
    ...
    return BeanInstanceSupplier.<ServletWebServerFactoryCustomizer>forFactoryMethod(ServletWebServerFactoryAutoConfiguration.class, "servletWebServerFactoryCustomizer", ServerProperties.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.servlet.ServletWebServerFactoryAutoConfiguration", ServletWebServerFactoryAutoConfiguration.class).servletWebServerFactoryCustomizer(args.get(0), args.get(1), args.get(2), args.get(3)));
  }
  ...
  public static BeanDefinition getServletWebServerFactoryCustomizerBeanDefinition() {
    ...
    beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.web.servlet.ServletWebServerFactoryAutoConfiguration");
    beanDefinition.setInstanceSupplier(getServletWebServerFactoryCustomizerInstanceSupplier());
    return beanDefinition;
  }

  /**
   * Bean definitions for {@link ServletWebServerFactoryAutoConfiguration.TomcatConfiguration}.
   */
  @Generated
  public static class TomcatConfiguration {
    /**
     * Get the bean definition for 'tomcatConfiguration'.
     */
    public static BeanDefinition getTomcatConfigurationBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(ServletWebServerFactoryAutoConfiguration.TomcatConfiguration.class);
      beanDefinition.setInstanceSupplier(ServletWebServerFactoryAutoConfiguration.TomcatConfiguration::new);
      return beanDefinition;
    }
    ...
    private static BeanInstanceSupplier<TomcatServletWebServerFactoryCustomizer> getTomcatServletWebServerFactoryCustomizerInstanceSupplier(
      ...
      return BeanInstanceSupplier.<TomcatServletWebServerFactoryCustomizer>forFactoryMethod(ServletWebServerFactoryAutoConfiguration.TomcatConfiguration.class, "tomcatServletWebServerFactoryCustomizer", ServerProperties.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean("org.springframework.boot.autoconfigure.web.servlet.ServletWebServerFactoryAutoConfiguration$TomcatConfiguration", ServletWebServerFactoryAutoConfiguration.TomcatConfiguration.class).tomcatServletWebServerFactoryCustomizer(args.get(0)));
    }
    ...
    public static BeanDefinition getTomcatServletWebServerFactoryCustomizerBeanDefinition() {
      ...
      beanDefinition.setFactoryBeanName("org.springframework.boot.autoconfigure.web.servlet.ServletWebServerFactoryAutoConfiguration$TomcatConfiguration");
