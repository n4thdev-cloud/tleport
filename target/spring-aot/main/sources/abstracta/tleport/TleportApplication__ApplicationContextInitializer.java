 ...
 */
@Generated
public class TleportApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new TleportApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new TleportApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.web.configuration.WebSecurityConfiguration", "abstracta.tleport.seguridad.SecurityConfig");
